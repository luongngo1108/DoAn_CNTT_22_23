...
public class CatePetWeiDao extends BaseDao {
	public String generateId() {
		String prefix = "PW";
		String count = _jdbcTemplate.queryForObject("select count(petwei_id) from petweight", Integer.class).toString();
	...
	public int saveCatePetWei(CatePetWei catePetWei) {
		String sql = "Insert into petweight(petwei_id, type) values('"+generateId()+"','" + catePetWei.getType() + "')";

...
public class PropertyDao extends BaseDao{
	public String generateId() {
		String prefix = "PP";
		String count = _jdbcTemplate.queryForObject("select count(proper_id) from properties", Integer.class).toString();
	...
	public int saveProperty(Property property) {
		...
		return _jdbcTemplate.update(sql, generateId(), property.getPetwei_id(), property.getColor_id(),

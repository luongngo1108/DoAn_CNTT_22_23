...
public class CateColorDao extends BaseDao {
	public String generateId() {
		String prefix = "CL";
		String count = _jdbcTemplate.queryForObject("select count(color_id) from color", Integer.class).toString();
	...
	public int saveCateColor(CateColor cateColor) {
		String sql = "Insert into Color(color_id, type) values('"+generateId()+"','" + cateColor.getType() + "')";

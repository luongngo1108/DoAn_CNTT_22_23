...
public class CateFoodFlaDao extends BaseDao {
	public String generateId() {
		String prefix = "FF";
		String count = _jdbcTemplate.queryForObject("select count(foodfla_id) from foodflavorings", Integer.class).toString();
	...
	public int saveCateFoodFla(CateFoodFla cateFoodFla) {
		String sql = "Insert into foodflavorings(foodfla_id, type) values('"+generateId()+"','" + cateFoodFla.getType() + "')";

...
public class ProductsDao extends BaseDao {
	public String generateId() {
		String prefix = "PR";
		String count = _jdbcTemplate.queryForObject("select count(pro_id) from product", Integer.class).toString();
	...
	public int saveProduct(ProductsDto productsDto) {
		...
		return _jdbcTemplate.update(sql, generateId(), productsDto.getProper_id(), productsDto.getCat_id(),productsDto.getSup_id(),
	...
	public int updateProduct(ProductsDto productsDto) {
		String sql = "Update product set proper_id=?,cat_id=?, sup_id=?, name=?, quantity=?, price=?, highlight=?, new_product=?, detail=?"
				+ ", created_at=?, updated_at=?, img=? where pro_id=? AND proper_id=?";
		return _jdbcTemplate.update(sql, productsDto.getProper_id(),productsDto.getCat_id(),productsDto.getSup_id(),
				productsDto.getPro_name(),productsDto.getQuantity(),productsDto.getPrice(), productsDto.getHighlight(),

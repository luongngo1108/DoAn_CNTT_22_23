...
public class SupplierDao extends BaseDao {
	public String generateId() {
		String prefix = "SU";
		String count = _jdbcTemplate.queryForObject("select count(sup_id) from supplier", Integer.class).toString();
	...
	public int saveSupplier(Supplier supplier) {
		...
		String sql = "Insert into Supplier(sup_id, name, address, phone) values('"+newId+"','"

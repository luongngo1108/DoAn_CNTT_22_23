...
public class CateMaterialDao extends BaseDao {
	public String generateId() {
		String prefix = "MA";
		String count = _jdbcTemplate.queryForObject("select count(materials_id) from materials", Integer.class).toString();
	...
	public int saveCateMaterial(CateMaterial cateMaterial) {
		String sql = "Insert into materials(materials_id, type) values('"+generateId()+"','" + cateMaterial.getType() + "')";

			...
			<div class="well well-small">
				<ul class="nav nav-list">
					<c:forEach var="item" items="${categories}" varStatus="index">
						<li><a href="/BanThuCung/product/"><span
				...
				<div id="myCarousel" class="carousel slide homCar">
					<div class="carousel-inner">
						<c:forEach var="item" items="${slides}" varStatus="index">
							...
							<img style="width: 100%"
								src="<c:url value="/assets/user/img/slides/${item.url}"/>"
								alt="bootstrap ecommerce templates">
					</div>
					</c:forEach>
				</div>
						...
						<c:forEach var="item" items="${products}" varStatus="loop">
							<li class="span4">
								<div class="thumbnail">
									<a class="zoomTool" href="product_details.html"
										title="add to cart"><span class="icon-search"></span>
										QUICK VIEW</a> <a href="chi-tiet-sam-pham/${item.pro_id}"><img
										src="<c:url value="/assets/user/img/products/${item.img}.jpg"/>" alt="" /></a>
									<div class="caption">
										<h5>${item.pro_name}</h5>
										<h4>

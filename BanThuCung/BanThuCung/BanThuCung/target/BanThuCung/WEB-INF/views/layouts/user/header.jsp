...
<header id="header">
	<div class="row">
		<div class="span4">
			<h1>
				<a class="logo" href=""><span>Twitter Bootstrap ecommerce
						template</span> <img src="<c:url value="/assets/user/img/logo-web.jpg"/>"
		...
		<div class="span4">
			<div class="offerNoteWrapper">
				<h1 class="dotmark">
					<i class="icon-cut"></i> Chào mừng bạn đến với FamiPet ! Mở cửa: 9h
					- 21h30, thứ 2 - CN hàng tuần
				</h1>
			</div>
		</div>
